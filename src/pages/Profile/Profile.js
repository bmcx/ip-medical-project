          ...
          <div>
            ...
            <div> <FormInput placeholder="E-mail" className="w-full mx-w-lg">
              ...
              <input className="flex"> </input>
               ...
               <FormInput placeholder="Mobile Number" className="w-full mx-w-lg">
                <div className="flex flex-wrap -mx-3 mb6"></div>
                <input className="flex"> </input>
                ...
                <FormInput placeholder="Date of Birth" required="ture" className="w-5">
                  <div className="flex flex-wrap -mx-3 mb6"></div>
                  <input className="flex"> </input>
                </FormInput>
                <FormInput placeholder="Height and Weight" required="ture" className="w-5">
                  <div className="flex flex-wrap -mx-3 mb6"></div>
                  <input className="flex"> </input>
                </FormInput>

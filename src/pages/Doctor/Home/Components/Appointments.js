	    ...
	    <table class="overflow-x-auto w-full bg-white">
	        <thead class="bg-blue-100 border-b border-gray-300">
	            <tr>
	                ...
	                <th class="p-4 text-left text-sm font-medium text-gray-500">Time</th>
	                <th class="p-4 text-left text-sm font-medium text-gray-500">Status</th>
	                <th class="p-4 text-left text-sm font-medium text-gray-500">Patient</th>
	                <th class="p-4 text-left text-sm font-medium text-gray-500">Phone Number</th>
	                <th class="p-4 text-left text-sm font-medium text-gray-500">Representative</th>
	        ...
	        <tbody class="text-gray-600 text-sm divide-y divide-gray-300">
	            <tr class="bg-white font-medium text-sm divide-y divide-gray-200">
	                ...
	                <td class="p-4 whitespace-nowrap">
	                    <span class="bg-indigo-100 text-indigo-600 text-xs font-semibold rounded-2xl py-1 px-4">New</span>
	                </td>
	                ...
	                <td class="p-4 whitespace-nowrap">
	                    <button class="bg-indigo-100 text-indigo-800 text-xs font-semibold px-4 py-2 rounded-md border-0">Start Session</button>
	                </td>
	            </tr>
	            <tr class="bg-white font-medium text-sm divide-y divide-gray-200">
	                <td class="p-4 whitespace-nowrap">20-02-2021</td>
	                <td class="p-4 whitespace-nowrap">09:00 am</td>
	                <td class="p-4 whitespace-nowrap">
	                    <span class="bg-yellow-100 text-yellow-600 text-xs font-semibold rounded-2xl py-1 px-4">Reg</span>
	                </td>
	            ...
	            <tr class="bg-white font-medium text-sm divide-y divide-gray-200">
	                ...
	                <td class="p-4 whitespace-nowrap">09:00 am</td>
	                <td class="p-4 whitespace-nowrap">
	                    <span class="border border-gray-300 text-gray-600 text-xs font-semibold rounded-2xl py-1 px-4">N/A</span>
	                </td>

...
export const IconSendOutline = ({ strokeWidth, colorClass }) => (
  <svg
    className={`stroke-current ${colorClass} w-6 m-auto`}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
export const IconBagOutline = ({ strokeWidth, colorClass }) => (
  <svg
    className={`stroke-current ${colorClass} w-6 m-auto`}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
export const IconCalendarOutline = ({ strokeWidth, colorClass }) => (
  <svg
    className={`stroke-current ${colorClass} w-6 m-auto`}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
export const IconUsersOutline = ({ strokeWidth, colorClass }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={`stroke-current ${colorClass} w-6 m-auto`}
    fill="none"
...
export const IconClipboard = ({strokeWidth , colorClass})=>(
  <svg 
  xmlns="http://www.w3.org/2000/svg"
   className={`stroke-current ${colorClass} w-6 m-auto`}
   viewBox="0 0 24 24" 
